...
function removeArtist(array, delind) {
  array.splice(delind, 1);
}
...
console.log(addArtist(20, 'mike', '1984-288', 'modern', 'italian', 'yo vip lets kick it'));
